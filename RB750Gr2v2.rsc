...
add address=177.71.206.0/24 list="CHECK UNIFI"
add address=192.168.1.254 list="CHECK UNIFI"
add address=my.jw.org list=JW
add address=login.jwpub.org list=JW
add address=ba.jw.org list=JW
/ip firewall filter
add action=accept chain=forward comment="JW List" dst-address-list=JW
add action=accept chain=forward comment="CHECK UNIFI In List" \
    src-address-list="CHECK UNIFI"
add action=accept chain=forward comment="CHECK UNIFI Out List" \
    dst-address-list="CHECK UNIFI"
